					...
					<form action="register" method="post">
					   <ul class="ul_form">
							...
							<li class="pwdmia">
								...
								<input type="password" class="pwd" name="name" placeholder="请输入收货人">
							</li>
							<li class="pwdmia">
								<i class="iconfont icon-shouji"></i>
								<input type="password" class="pwd" name="phone" placeholder="请输入收货电话">
							</li>
							<li class="pwdmia">
								<i class="iconfont icon-home_list"></i>
								<input type="password" class="pwd" name="address" placeholder="请输入收货地址">
							</li>
						</ul>
