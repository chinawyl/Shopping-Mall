...
public interface GoodsDao {
	...
	@Insert("insert into goods (cover,name,intro,spec,price,stock,type_id) "
			+ "values (#{cover},#{name},#{intro},#{spec},#{price},#{stock},#{typeId})")
	...
	@Update("update goods set cover=#{cover},name=#{name},intro=#{intro},spec=#{spec},price=#{price},"
			+ "stock=#{stock},type_id=#{typeId} where id=#{id}")
